...
Arc automatically detects whether a repository is public or private. Public repositories are cloned without credentials. Private repositories get a short-lived, minimally-scoped IAT generated from the GitHub App configured during `arc install`.
...
- Fixed duplicate `.env` variables when re-running `arc install`
</Accordion>
