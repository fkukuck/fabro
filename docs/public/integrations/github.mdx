...
| **Issue intake** | [GitHub issue intake](/integrations/github-issue-intake) starts automations when a matching label is added to an issue |
...
The manifest grants Issues permission but does not subscribe to webhook events by default. Enable the **Issues** event in the GitHub App settings before using [GitHub issue intake](/integrations/github-issue-intake).
