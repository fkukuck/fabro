...
| `fabro install` | Set up the Fabro environment (server settings, Azure, object store, LLMs, GitHub) |
...
Set up the Fabro environment (server settings, Azure, object store, LLMs, GitHub)
