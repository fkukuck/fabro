...
MODELS = [
    ...
    ModelInfo(id="gpt-5-mini",                     provider="openai",    display_name="GPT-5 Mini",        context_window=1047576, supports_tools=true, supports_vision=true, supports_reasoning=true),
