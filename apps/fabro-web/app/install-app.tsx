  ...
  return (
    <div>
      ...
      <p className="mt-4 max-w-[56ch] text-base/7 text-fg-3 text-pretty sm:text-[0.9375rem]/7">
        ...
        sandbox platform settings, choose the shared object store and sandbox
        runtime, validate your LLM credentials, and connect GitHub. When you
        finish, Fabro restarts into normal mode.
      </p>
